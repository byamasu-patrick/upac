 ...
 * @author user
 */
public class PayementAssuranceMaladie extends javax.swing.JDialog {
    ...
    public PayementAssuranceMaladie(java.awt.Frame parent, boolean modal) {
        super(parent, modal);        
        initComponents();
        addItemToSpinner();
        db = Login.db;
    ...
    private void initComponents() {
        ...
        jPanel1.add(createStudent, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 330, 190, 50));
        ...
        jLabel16.setText("Assurance Maladie");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 260, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayementAssuranceMaladie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PayementAssuranceMaladie dialog = new PayementAssuranceMaladie(new javax.swing.JFrame(), true);
        ...
        if (!nom.getText().equals("") && !postnom.getText().equals("") && !prenom.equals("")
            ...
            if (file != null) {
                ...
                if ( studentId != 0) {  
                    ...
                    db.appPayementAssuranceMaladie(studentId, numeroBord.getText(),
