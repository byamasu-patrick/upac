 ...
 * @author user
 */
public class ShowInfoDivers extends javax.swing.JDialog {

    /**
     * Creates new form ShowInfo
     */
    private DatabaseManager db;
    public static boolean stateAttente = false;
    public static boolean stateConfirme = false;
    
    public ShowInfoDivers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
       ...
       //JOptionPane.showMessageDialog(null, UniversalMethod.studentDataAttenteBAC1.size());
        if (stateAttente) {
            UniversalMethod.populateTableStudentDivers(table, UniversalMethod.fraisDiversAttente);
        }
        else if (stateConfirme) {
            UniversalMethod.populateTableStudentDivers(table, UniversalMethod.fraisDiversConfirme);
        }
        else{
            UniversalMethod.populateTableStudentDivers(table, UniversalMethod.fraisDivers);
        }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        this.dispose();
        new StudentDetailDivers(new JFrame(), true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowInfoDivers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ShowInfoDivers dialog = new ShowInfoDivers(new javax.swing.JFrame(), true);
