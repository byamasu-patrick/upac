...
import upac.helper.AjouteEtudiant;
...
public class Inscription extends javax.swing.JFrame {
    ...
    public static Inscription frame;
    /**
...
//        db.confirme("BAC 2");
//        db.confirme("BAC 3");
        setDefaultImage(new ImageIcon(getClass().getResource("/images/upac-logo-300x298.png")), logo);
        String[] name = UniversalMethod.memberData.getNom().split(" ");
        fullname.setText(name[0] +" "+ name[1]);
        setDefaultImage(UniversalMethod.convertStringToImageIcon( UniversalMethod.memberData.getProfile()), profile);
    ...
    private void initComponents() {
        ...
        frais_acad.setText("Incrire Etud");
        ...
        jPanel1.add(statistic, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 230, 420, 360));
        ...
        statistic1Layout.setVerticalGroup(
            statistic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, statistic1Layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(panelStatistic1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jPanel1.add(statistics, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 420, 360));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 270, 100));
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 110, 280, 100));
        ...
        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(834, 110, 260, 100));
    ...
    private void frais_acadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_frais_acadActionPerformed
        ...
        AjouteEtudiant maladie = new AjouteEtudiant(this, true);
    ...
    private void frais_malActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_frais_malActionPerformed
        // TODO add your handling code here:
        db.attenteAndConfirme(1, "BAC 1");
        db.attenteAndConfirme(1, "BAC 2");
        db.attenteAndConfirme(1, "BAC 3");
        new ShowInfo(this, true).setVisible(true);
...
//        UniversalMethod.memberData = null;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frame = new Inscription();
                frame.setVisible(true);
                //System.out.println("Number is : "+ UniversalMethod.studentDataAttenteBAC1.size());
            }
        });
