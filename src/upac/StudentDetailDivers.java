...
import static upac.StudentDetailAcademique.apparitora;
import static upac.StudentDetailAcademique.rowId;
 ...
 * @author user
 */
public class StudentDetailDivers extends javax.swing.JDialog {
    ...
    ArrayList<FraisDiversStudent> student;
    
    public StudentDetailDivers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db = Login.db;
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/images/upac-logo-300x298.png")));
        student = UniversalMethod.fraisDivers;
        if (student != null) {
...
//        }
    ...
    private void activeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_activeActionPerformed
        ...
        db.confirmationStatusPayementDivers(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentDetailDivers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                StudentDetailDivers dialog = new StudentDetailDivers(new javax.swing.JFrame(), true);
