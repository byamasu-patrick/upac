 ...
 * @author user
 */
public class FraisMaladieStudent {
    ...
    public FraisMaladieStudent() {
    }

    public FraisMaladieStudent(String fullname, String promotion, String faculte, String profile, String matricule, String bordereau, String numeroBordereau, int fraisId, int studentId) {
