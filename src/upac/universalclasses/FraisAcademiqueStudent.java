 ...
 * @author user
 */
public class FraisAcademiqueStudent {
    ...
    public FraisAcademiqueStudent() {
    }

    public FraisAcademiqueStudent(String fullname, String promotion, String faculte, String profile, String matricule, String bordereau, String tranche, String numeroBordereau, int fraisId, int studentId) {
